...
//
//  FPS-style Euler-angle camera used for the VIEWING TRANSFORMATION.
//  Pattern follows the course template by Nazirul Hasan, extended with
//  UP / DOWN fly movement so the user can look around a full 3D room.
//
...
public:
    ...
    // ---- THIS is the viewing transformation used every frame in main.cpp ----
